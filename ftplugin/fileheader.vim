...
function s:AddHeader()
    ...
    let gotoLn = line('.')
    normal o
    call setline('.',noTypeChar.preChar.'       Author: '.g:fileheader_author)
    normal o
    call setline('.',noTypeChar.preChar.'        Email: '.g:fileheader_email)
    normal o
